(function () {
    ...
    var data = [
        ...
        },
        {
            ...
            level:1,
            children:[
                {id:'003',level:2,icon:'',title:'老人管理',path:'oldman.html',children:[]},
                {id:'004',level:2,icon:'',title:'工作人员管理',path:'stuff.html',children:[]},
                {id:'005',level:2,icon:'',title:'义工管理',path:'/volunteer/page',children:[]}
            ]
        },
        {
            id:'006',
            ...
            level:1,
            children:[
                {id:'007',level:2,icon:'',title:'监控',path:'camera.html',children:[]}
            ]
        }
    ];
